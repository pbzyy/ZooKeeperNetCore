...
namespace ZooKeeperNet
{
    ...
    public class ZooKeeper : IDisposable, IZooKeeper
    {
        ...
        /// <returns></returns>
        public async Task<string> Create(string path, byte[] data, IEnumerable<ACL> acl, CreateMode createMode)
        {
            ...
            ReplyHeader r = await cnxn.SubmitRequest(h, request, response, null);
            if (r.Err != 0)
            {
        ...
        public async Task Delete(string path, int version)
        {
            string clientPath = path;
            ...
            ReplyHeader r = await cnxn.SubmitRequest(h, request, null, null);
            if (r.Err != 0)
            {
                throw KeeperException.Create((KeeperException.Code)Enum.ToObject(typeof(KeeperException.Code), r.Err), clientPath);
            }
        ...
        public async Task<Stat> Exists(string path, IWatcher watcher)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
            ...
            ReplyHeader r = await cnxn.SubmitRequest(h, request, response, wcb);
            if (r.Err != 0)
            {
        ...
        /// </summary>
        public Task<Stat> Exists(string path, bool watch)
        {
        ...
        /// </summary>
        public async Task<byte[]> GetData(string path, IWatcher watcher, Stat stat)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
        ...
        /// @throws InterruptedException If the server transaction is interrupted.
        /// </summary>
        public Task<byte[]> GetData(string path, bool watch, Stat stat)
        {
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        public async Task<Stat> SetData(string path, byte[] data, int version)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        public async Task<IEnumerable<ACL>> GetACL(string path, Stat stat)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        public async Task<Stat> SetACL(string path, IEnumerable<ACL> acl, int version)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
            if (acl != null && acl.Count() == 0)
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        public async Task<IEnumerable<string>> GetChildren(string path, IWatcher watcher)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
        ...
        public Task<IEnumerable<string>> GetChildren(string path, bool watch)
        {
        ...
        public async Task<IEnumerable<string>> GetChildren(string path, IWatcher watcher, Stat stat)
        {
            string clientPath = path;
            PathUtils.ValidatePath(clientPath);
        ...
        ///  error code.
        /// </summary>
        public Task<IEnumerable<string>> GetChildren(string path, bool watch, Stat stat)
        {
