...
namespace ZooKeeperNet
{
    ...
    public interface IZooKeeper
    {
        ...
        /// <returns></returns>
        Task<string> Create(string path, byte[] data, IEnumerable<ACL> acl, CreateMode createMode);
        ...
        Task Delete(string path, int version);
        ...
        Task<Stat> Exists(string path, IWatcher watcher);
        ...
        /// </summary>
        Task<Stat> Exists(string path, bool watch);
        ...
        /// </summary>
        Task<byte[]> GetData(string path, IWatcher watcher, Stat stat);
        ...
        /// @throws InterruptedException If the server transaction is interrupted.
        /// </summary>
        Task<byte[]> GetData(string path, bool watch, Stat stat);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        Task<IEnumerable<ACL>> GetACL(string path, Stat stat);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        Task<Stat> SetACL(string path, IEnumerable<ACL> acl, int version);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        Task<IEnumerable<string>> GetChildren(string path, IWatcher watcher);

        Task<IEnumerable<string>> GetChildren(string path, bool watch);
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        Task<IEnumerable<string>> GetChildren(string path, IWatcher watcher, Stat stat);
        ...
        ///  error code.
        /// </summary>
        Task<IEnumerable<string>> GetChildren(string path, bool watch, Stat stat);
